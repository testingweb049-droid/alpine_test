...
export default function Confirmation() {
  ...
  const showRoute =
    bookingData.rateType === "trip" && hasPickup && hasDropoff;
  ...
  // 💥 FIXED useEffect — added safety checks
  useEffect(() => {
    ...
    // TS-safe validation (prevents undefined errors)
    ...
    <div className="lg:col-span-3">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* MAP */}
          <div className="mt-6 h-80 rounded-lg overflow-hidden border border-gray-200">
            <GoogleMap
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-[#F8F8F8] p-6">
            ...
            <p className="text-sm text-gray-700 font-semibold">Guest</p>
